# Security Portfolio: [Brandon]

Documented cloud security investigations, built in a live Azure tenant
(Mad Hat Labs, a multi-user training environment).

Target role: SOC Analyst / IAM engineer
Currently: [Desktop and mobility] | [Alpheretta]
Contact: [tyler.mcb38@gmail.com] · [www.linkedin.com/in/brandon-brown-16a77426a]

## Investigations
| # | Title | Focus | Write-up |
|---|-------|-------|----------|
| 1 | Operation Dead Deploy | Governance forensics, deployment audit trail Operation Dead Deploy investigation https://github.com/BrandoB-K/security-portfolio/blob/main/Operation-Dead-Deploy-investigation
